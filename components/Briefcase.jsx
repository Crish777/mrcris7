      ...
      <div className={`container ${styles.briefcaseContainer}`}>
        <div className={`${styles.infoWork}`}>
          <div className={`${styles.innerInfoWork}`}>
            <h2 className={`${styles.infoWorkTitle} ${audiowide.className}`} data-scroll data-scroll-direction="horizontal" data-scroll-speed={-1}>
              Mis trabajos
            </h2>
          </div>
        </div>
        ...
        <div className={`${styles.works}`}>
          {projects.map((el, index) => (
            <Project key={el.id} data={el} audiowide={audiowide}/>
          ))}
        </div>
      </div>
    </section>
