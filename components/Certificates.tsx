      ...
      <div className={'container '}>
        ...
        <Slider asNavFor={nav2} ref={(slider: any) => (sliderRef1 = slider)}>
          <div className={styles.contIframe}>
            <iframe src="https://www.hackerrank.com/certificates/iframe/172490e8c00d">
              {' '}
            </iframe>
          </div>
          <div className={styles.contIframe}>
            <iframe src="https://www.hackerrank.com/certificates/iframe/33a474c27690">
              {' '}
            </iframe>
          </div>
          <div className={styles.contIframe}>
            <iframe src="https://www.hackerrank.com/certificates/iframe/a27152a6cf2a">
              {' '}
            </iframe>
          </div>
          <div className={styles.contIframe}>
            <iframe src="https://www.hackerrank.com/certificates/iframe/d4a8f78bf502">
              {' '}
            </iframe>
          </div>
        </Slider>
